...
import org.bitbucket.cowwoc.requirements.core.util.Lists;
...
public final class Configuration implements Verifier
{
	...
	private Configuration(Class<? extends RuntimeException> exceptionOverride,
		List<Entry<String, Object>> context)
	{
	 ...
	 */
	@Override
	public Configuration withContext(List<Entry<String, Object>> context)
	{
		if (context == null)
