 ...
 * @author Gili Tzabari
 */
final class BigDecimalScaleVerifierImpl implements BigDecimalScaleVerifier
{
	 ...
	 *                        {@code name} is empty
	 */
	BigDecimalScaleVerifierImpl(SingletonScope scope, BigDecimal actual, String name,
