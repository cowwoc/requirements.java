 ...
 * @author Gili Tzabari
 */
class PrimitiveIntegerVerifierImpl implements PrimitiveIntegerVerifier
{
	 ...
	 *                        {@code name} is empty
	 */
	protected PrimitiveIntegerVerifierImpl(SingletonScope scope, int actual, String name,
