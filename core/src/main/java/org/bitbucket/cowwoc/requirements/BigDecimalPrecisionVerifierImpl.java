 ...
 * @author Gili Tzabari
 */
final class BigDecimalPrecisionVerifierImpl implements BigDecimalPrecisionVerifier
{
	 ...
	 */
	BigDecimalPrecisionVerifierImpl(SingletonScope scope, BigDecimal actual, String name,
