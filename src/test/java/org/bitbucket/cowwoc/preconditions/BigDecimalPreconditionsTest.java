...
public class BigDecimalPreconditionsTest
{
	...
	@Test
	public void hasPrecisionInLowerBound()
	{
		BigDecimal parameter = BigDecimal.valueOf(123, 2);
		Range<Integer> range = Range.closed(3, 5);
		Preconditions.requireThat(parameter, "parameter").hasPrecisionIn(range);
	}

	@Test
	public void hasPrecisionInBounds()
	{
	...
	@Test
	public void hasPrecisionInUpperBound()
	{
		BigDecimal parameter = BigDecimal.valueOf(12345, 2);
		Range<Integer> range = Range.closed(3, 5);
		Preconditions.requireThat(parameter, "parameter").hasPrecisionIn(range);
	}

	@Test(expectedExceptions = IllegalArgumentException.class)
	public void hasPrecisionFalseOpenRange()
	{
		BigDecimal parameter = BigDecimal.valueOf(123, 2);
	...
	@Test(expectedExceptions = IllegalArgumentException.class)
	public void hasPrecisionFalseClosedRange()
	{
		BigDecimal parameter = BigDecimal.valueOf(123, 2);
	...
	@Test
	public void hasScaleInLowerBound()
	{
		BigDecimal parameter = BigDecimal.valueOf(123, 3);
		Range<Integer> range = Range.closed(3, 5);
		Preconditions.requireThat(parameter, "parameter").hasScaleIn(range);
	}

	@Test
	public void hasScaleInBounds()
	{
	...
	@Test
	public void hasScaleInUpperBound()
	{
		BigDecimal parameter = BigDecimal.valueOf(12345, 5);
		Range<Integer> range = Range.closed(3, 5);
		Preconditions.requireThat(parameter, "parameter").hasScaleIn(range);
	}

	@Test(expectedExceptions = IllegalArgumentException.class)
	public void hasScaleFalseOpenRange()
	{
		BigDecimal parameter = BigDecimal.valueOf(123, 2);
		Range<Integer> range = Range.open(10, 20);
		Preconditions.requireThat(parameter, "parameter").hasScaleIn(range);
	...
	@Test(expectedExceptions = IllegalArgumentException.class)
	public void hasScaleFalseClosedRange()
	{
		BigDecimal parameter = BigDecimal.valueOf(123, 2);
		Range<Integer> range = Range.closed(10, 20);
		Preconditions.requireThat(parameter, "parameter").hasScaleIn(range);
