...
final class MapSizePreconditionsImpl
	...
	PrimitiveIntegerPreconditions<MapSizePreconditions>
{
	...
	@Override
	public MapSizePreconditions isGreaterThanOrEqualTo(Integer value) throws IllegalArgumentException
	{
	...
	@Override
	public MapSizePreconditions isLessThanOrEqualTo(Integer value) throws IllegalArgumentException
	{
		Preconditions.requireThat(value, "value").isNotNull();
		if (parameter <= value)
			return self;
	...
	@Override
	public MapSizePreconditions isLessThanOrEqualTo(Integer value, String name) throws
	...
	@Override
	public MapSizePreconditions isLessThan(Integer value, String name) throws IllegalArgumentException
	{
		Preconditions.requireThat(value, "value").isNotNull();
		Preconditions.requireThat(name, "name").isNotNull();
		if (parameter < value)
	...
	public MapSizePreconditions isEqualTo(Integer value) throws IllegalArgumentException
	{
		...
		if (Objects.equals(parameter, value))
			return self;
		return throwException(IllegalArgumentException.class,
			String.format("%s must contain %d entries. It contained %s (%d entries)", name, value, map,
				parameter));
	}
}
