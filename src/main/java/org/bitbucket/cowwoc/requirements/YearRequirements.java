 ...
 * @author Gili Tzabari
 */
public interface YearRequirements extends ObjectRequirements<YearRequirements, Year>
{
	/**
	 ...
	 */
	YearRequirements isGreaterThan(Year value, String name) throws IllegalArgumentException;
	 ...
	 */
	YearRequirements isGreaterThan(Year value) throws IllegalArgumentException;
	 ...
	 */
	YearRequirements isGreaterThanOrEqualTo(Year value, String name) throws IllegalArgumentException;
	 ...
	 */
	YearRequirements isGreaterThanOrEqualTo(Year value) throws IllegalArgumentException;
	 ...
	 */
	YearRequirements isIn(Range<Year> range) throws NullPointerException, IllegalArgumentException;
	 ...
	 */
	YearRequirements isLessThan(Year value, String name) throws IllegalArgumentException;
	 ...
	 *                                  {@code value}
	 */
	YearRequirements isLessThan(Year value) throws IllegalArgumentException;
	 ...
	 */
	YearRequirements isLessThanOrEqualTo(Year value, String name) throws IllegalArgumentException;
	 ...
	 */
	YearRequirements isLessThanOrEqualTo(Year value) throws IllegalArgumentException;
}
