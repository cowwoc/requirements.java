 ...
 * @author Gili Tzabari
 */
public interface CollectionRequirements<E, T extends Collection<E>>
	extends ObjectRequirements<CollectionRequirements<E, T>, T>
{
	/**
	 ...
	 */
	CollectionRequirements<E, T> isEmpty() throws IllegalArgumentException;
	 ...
	 */
	CollectionRequirements<E, T> isNotEmpty() throws IllegalArgumentException;
	 ...
	 */
	CollectionRequirements<E, T> contains(E element) throws IllegalArgumentException;
	 ...
	 *                                  {@code name} is empty
	 */
	CollectionRequirements<E, T> contains(E element, String name)
	 ...
	 *                                  {@code elements}
	 */
	CollectionRequirements<E, T> containsExactly(Collection<E> elements)
		throws NullPointerException, IllegalArgumentException;
	 ...
	 */
	CollectionRequirements<E, T> containsExactly(Collection<E> elements, String name)
		throws NullPointerException, IllegalArgumentException;
	 ...
	 */
	CollectionRequirements<E, T> containsAny(Collection<E> elements)
		throws NullPointerException, IllegalArgumentException;
	 ...
	 *                                  {@code name} is empty
	 */
	CollectionRequirements<E, T> containsAny(Collection<E> elements, String name)
		throws NullPointerException, IllegalArgumentException;
	 ...
	 */
	CollectionRequirements<E, T> containsAll(Collection<E> elements)
		throws NullPointerException, IllegalArgumentException;
	 ...
	 *                                  {@code name} is empty
	 */
	CollectionRequirements<E, T> containsAll(Collection<E> elements, String name)
		throws NullPointerException, IllegalArgumentException;
	 ...
	 */
	CollectionRequirements<E, T> doesNotContain(E element) throws IllegalArgumentException;
	 ...
	 *                                  empty
	 */
	CollectionRequirements<E, T> doesNotContain(E element, String name)
		throws NullPointerException, IllegalArgumentException;
	 ...
	 */
	CollectionRequirements<E, T> doesNotContainAny(Collection<E> elements)
		throws NullPointerException, IllegalArgumentException;
	 ...
	 *                                  {@code name} is empty
	 */
	CollectionRequirements<E, T> doesNotContainAny(Collection<E> elements, String name)
		throws NullPointerException, IllegalArgumentException;
	 ...
	 */
	CollectionRequirements<E, T> doesNotContainAll(Collection<E> elements)
		throws NullPointerException, IllegalArgumentException;
	 ...
	 *                                  {@code name} is empty
	 */
	CollectionRequirements<E, T> doesNotContainAll(Collection<E> elements, String name)
		throws NullPointerException, IllegalArgumentException;
	 ...
	 */
	CollectionRequirements<E, T> doesNotContainDuplicates()
