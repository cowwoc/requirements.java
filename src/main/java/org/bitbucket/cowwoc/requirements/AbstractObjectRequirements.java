...
/**
 * Abstract implementation of ObjectRequirements.
 * <p>
 * @param <S> the type of requirements that was instantiated
 * @param <T> the type of the parameter
 * @author Gili Tzabari
 */
public abstract class AbstractObjectRequirements<S extends ObjectRequirements<S, T>, T>
	implements ObjectRequirements<S, T>
{
	 ...
	 */
	protected AbstractObjectRequirements(T parameter, String name,
