...
public final class ArrayTest
{
	...
	public void lengthIsEqualTo()
	{
		try (ApplicationScope scope = new TestApplicationScope(NONE))
		{
			...
			new CoreVerifiers(scope).requireThat(actual, "actual").length().isEqualTo(1);
		}
	}
	...
	public void lengthIsEqualTo_False()
	{
		try (ApplicationScope scope = new TestApplicationScope(NONE))
		{
			...
			new CoreVerifiers(scope).requireThat(actual, "actual").length().isEqualTo(2);
		}
	}
	...
	public void lengthIsEqualToVariable()
	{
		try (ApplicationScope scope = new TestApplicationScope(NONE))
		{
			...
			new CoreVerifiers(scope).requireThat(actual, "actual").length().
	...
	public void lengthIsNotEqualTo()
	{
		try (ApplicationScope scope = new TestApplicationScope(NONE))
		{
			...
			new CoreVerifiers(scope).requireThat(actual, "actual").length().isNotEqualTo(2);
		}
	}
	...
	public void lengthIsNotEqualTo_False()
	{
		try (ApplicationScope scope = new TestApplicationScope(NONE))
		{
			...
			new CoreVerifiers(scope).requireThat(actual, "actual").length().isNotEqualTo(1);
		}
	}
	...
	public void isInRange_expectedIsLowerBound()
	{
		try (ApplicationScope scope = new TestApplicationScope(NONE))
		{
			...
			new CoreVerifiers(scope).requireThat(actual, "actual").length().isBetween(3, 5);
		}
	}
	...
	public void asCollection()
	{
		try (ApplicationScope scope = new TestApplicationScope(NONE))
		{
			...
			List<Integer> output = new ArrayList<>(verifier.requireThat(actual, "actual").
				asCollection().getActual());
			verifier.requireThat(input, "Input").isEqualTo(output, "Output");
		}
	}
	...
	public void asArray_False()
	{
		try (ApplicationScope scope = new TestApplicationScope(NONE))
		{
			...
			List<Integer> actualOutput = new ArrayList<>(verifier.requireThat(actual, "actual").
				asCollection().getActual());
