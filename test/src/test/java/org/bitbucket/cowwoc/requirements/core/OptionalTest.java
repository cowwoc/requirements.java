...
public final class OptionalTest
{
	...
	public void isPresent()
	{
		try (ApplicationScope scope = new TestApplicationScope(NONE))
		{
			...
			new CoreVerifiers(scope).requireThat(actual, "actual").isPresent();
		}
	}
	...
	public void contains()
	{
		...
		{
			Optional<?> actual = Optional.of(5);
			new CoreVerifiers(scope).requireThat(actual, "actual").contains(5);
		}
	}
	...
	public void contains_False()
	{
		...
		{
			Optional<?> actual = Optional.of(5);
			new CoreVerifiers(scope).requireThat(actual, "actual").contains(6);
		}
	}
	...
	public void containsEmpty()
	{
		...
		{
			Optional<?> actual = Optional.empty();
			new CoreVerifiers(scope).requireThat(actual, "actual").contains(null);
		}
	}
	...
	public void contains_expectedIsEmptyVariable()
	{
		...
		{
			Optional<?> actual = Optional.of(5);
			new CoreVerifiers(scope).requireThat(actual, "actual").contains(null, "expected");
		}
	}
