...
public final class InetAddressTest
{
	...
	public void isIpV4() throws UnknownHostException
	{
		try (ApplicationScope scope = new TestApplicationScope(NONE))
		{
			...
			new CoreRequirementVerifier(scope).requireThat(actual, "actual").isIpV4();
		}
	}
	...
	public void isIpV6() throws UnknownHostException
	{
		...
		{
			InetAddress actual = InetAddress.getByName("2001:db8:a0b:12f0::1");
			new CoreRequirementVerifier(scope).requireThat(actual, "actual").isIpV6();
		}
	}
	...
	public void asIpAddress_actualIsIpV4()
	{
		try (ApplicationScope scope = new TestApplicationScope(NONE))
		{
			...
			new CoreRequirementVerifier(scope).requireThat(actual, "actual").asInetAddress();
		}
	}
	...
	public void fromString()
	{
		...
		{
			String actual = "1.2.3.4";
			InetAddress actualAsInetAddress = new CoreRequirementVerifier(scope).
