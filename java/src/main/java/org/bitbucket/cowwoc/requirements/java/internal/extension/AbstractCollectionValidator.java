	...
	implements ExtensibleCollectionValidator<S, C, E>
{
	 ...
	 *                        {@code name} is empty.
	 */
	public AbstractCollectionValidator(ApplicationScope scope, Configuration config, String name, C actual,
	...
	@Override
	public S asArray(Class<E> type, Consumer<ArrayValidator<E>> consumer)
	{
		if (type == null)
			throw new NullPointerException("type may not be null");
		if (consumer == null)
