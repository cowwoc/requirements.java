 ...
 */
public abstract class AbstractFloatVerifierVerifier<S>
	extends AbstractNumberVerifier<S, Float>
	implements ExtensibleFloatingPointVerifier<S, Float>
{
	 ...
	 *                        empty.
	 */
	protected AbstractFloatVerifierVerifier(ApplicationScope scope, String name, Float actual,
