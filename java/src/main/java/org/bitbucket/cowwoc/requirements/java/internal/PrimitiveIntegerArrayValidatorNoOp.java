...
/**
 * An implementation of {@code PrimitiveIntegerArrayValidator} that does nothing.
 */
public final class PrimitiveIntegerArrayValidatorNoOp
	extends AbstractArrayValidatorNoOp<PrimitiveIntegerArrayValidator, Integer, int[]>
	implements PrimitiveIntegerArrayValidator
{
	 ...
	 */
	public PrimitiveIntegerArrayValidatorNoOp(ApplicationScope scope, Configuration config,
