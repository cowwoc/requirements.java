...
public final class PrimitiveLongValidatorImpl
	extends ExtensibleIntegerValidatorImpl<PrimitiveIntegerValidator<Long>, Long>
	implements PrimitiveIntegerValidator<Long>
{
	 ...
	 *                        {@code name} is empty.
	 */
	public PrimitiveLongValidatorImpl(ApplicationScope scope, String name, Long actual, Configuration config,
