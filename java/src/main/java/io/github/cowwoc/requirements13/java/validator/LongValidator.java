...
public interface LongValidator extends
	ValidatorComponent<LongValidator, Long>,
	NegativeNumberComponent<LongValidator>,
	ZeroNumberComponent<LongValidator>,
	PositiveNumberComponent<LongValidator>,
	ObjectComponent<LongValidator, Long>,
	ComparableComponent<LongValidator, Long>
{
	/**
	 ...
	 *                                    <li>{@code minimumIsInclusive} is {@code false} and the value is
	 *                                    less than or equal to {@code minimum}</li>
	 ...
	 *                                  </ul>
	 */
	LongValidator isBetween(long minimum, boolean minimumIsInclusive, long maximum, boolean maximumIsInclusive);
}