...
/**
 * Validates the state of an {@code Integer} that does not support negative values.
 */
public interface UnsignedIntegerValidator extends
	ValidatorComponent<UnsignedIntegerValidator, Integer>,
	ObjectComponent<UnsignedIntegerValidator, Integer>,
	ZeroNumberComponent<UnsignedIntegerValidator>,
	PositiveNumberComponent<UnsignedIntegerValidator>,
	ComparableComponent<UnsignedIntegerValidator, Integer>
{
	/**
	 ...
	 */
	UnsignedIntegerValidator isMultipleOf(int factor);
	 ...
	 *                                  </ul>
	 */
	UnsignedIntegerValidator isMultipleOf(int factor, String name);
	 ...
	 */
	UnsignedIntegerValidator isNotMultipleOf(int factor);
	 ...
	 *                                  </ul>
	 */
	UnsignedIntegerValidator isNotMultipleOf(int factor, String name);
	 ...
	 */
	UnsignedIntegerValidator isLessThan(int maximumExclusive);
	 ...
	 *                                  </ul>
	 */
	UnsignedIntegerValidator isLessThan(int maximumExclusive, String name);
	 ...
	 */
	UnsignedIntegerValidator isLessThanOrEqualTo(int maximumInclusive);
	 ...
	 *                                  </ul>
	 */
	UnsignedIntegerValidator isLessThanOrEqualTo(int maximumInclusive, String name);
	 ...
	 */
	UnsignedIntegerValidator isGreaterThanOrEqualTo(int minimumInclusive);
	 ...
	 *                                  </ul>
	 */
	UnsignedIntegerValidator isGreaterThanOrEqualTo(int minimumInclusive, String name);
	 ...
	 */
	UnsignedIntegerValidator isGreaterThan(int minimumExclusive);
	 ...
	 *                                  </ul>
	 */
	UnsignedIntegerValidator isGreaterThan(int minimumExclusive, String name);
	 ...
	 *                                  </ul>
	 */
	UnsignedIntegerValidator isBetween(int minimumInclusive, int maximumExclusive);
	 ...
	 *                                  </ul>
	 */
	UnsignedIntegerValidator isBetween(int minimum, boolean minimumIsInclusive, int maximum,
