	...
	implements PrimitiveLongValidator
{
	 ...
	 */
	public PrimitiveLongValidatorImpl(ApplicationScope scope, AbstractValidator<?> validator, String name,
		long value)
	{
	 ...
	 *                                  leading or trailing whitespace, or is empty.
	 */
	public PrimitiveLongValidatorImpl(ApplicationScope scope, Configuration configuration,
	 ...
	 *                                  leading or trailing whitespace, or is empty.
	 */
	private PrimitiveLongValidatorImpl(ApplicationScope scope, Configuration configuration,
		String name,
