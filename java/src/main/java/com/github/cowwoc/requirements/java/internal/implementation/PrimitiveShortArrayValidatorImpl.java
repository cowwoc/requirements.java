	...
	implements PrimitiveShortArrayValidator
{
	 ...
	 */
	public PrimitiveShortArrayValidatorImpl(ApplicationScope scope, AbstractValidator<?> validator, String name,
		short[] value)
	{
	 ...
	 *                                  leading or trailing whitespace, or is empty.
	 */
	public PrimitiveShortArrayValidatorImpl(ApplicationScope scope, Configuration configuration,
	 ...
	 *                                  leading or trailing whitespace, or is empty.
	 */
	private PrimitiveShortArrayValidatorImpl(ApplicationScope scope, Configuration configuration,
		String name, short[] value, Map<String, Object> context, List<ValidationFailure> failures)
	{
