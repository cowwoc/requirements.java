...
public final class Writer16MillionColors extends AbstractColorWriter
{
	...
	{
		return DiffConstants.PREFIX + GRAY_FOREGROUND + DiffConstants.POSTFIX + DiffConstants.PREFIX + DEFAULT_BACKGROUND + DiffConstants.POSTFIX + text;
	}

	@Override
	public String decorateDeletedText(String text)
	{
		return DiffConstants.PREFIX + WHITE_FOREGROUND + DiffConstants.POSTFIX + DiffConstants.PREFIX + RED_BACKGROUND + DiffConstants.POSTFIX + text;
	}

	@Override
	public String decorateInsertedText(String text)
	{
		return DiffConstants.PREFIX + WHITE_FOREGROUND + DiffConstants.POSTFIX + DiffConstants.PREFIX + GREEN_BACKGROUND + DiffConstants.POSTFIX + text;
	}

	@Override
	public String decoratePadding(String text)
	{
		return DiffConstants.PREFIX + GRAY_FOREGROUND + DiffConstants.POSTFIX + DiffConstants.PREFIX + GRAY_BACKGROUND + DiffConstants.POSTFIX + text;
	}
