...
/**
 * Validates the state of an {@code int} value that supports negative values.
 * <p>
...
public interface PrimitiveUnsignedIntegerValidator extends
	Validator<PrimitiveUnsignedIntegerValidator>,
	NegativeNumber<PrimitiveUnsignedIntegerValidator>,
	UnsignedNumber<PrimitiveUnsignedIntegerValidator>
{
	/**
	 * Returns the value that is being validated.
	 *
	 * @return the validated value, or {@code 0} if a validation failed
	 */
	@CheckReturnValue
	int getValue();
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isEqualTo(int expected);
	 ...
	 * @see ConfigurationUpdater#equalityMethod() The method used to compare objects
	 */
	PrimitiveUnsignedIntegerValidator isEqualTo(int expected, String name);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isNotEqualTo(int unwanted);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isNotEqualTo(int unwanted, String name);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isMultipleOf(int factor);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isMultipleOf(int factor, String name);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isNotMultipleOf(int factor);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isNotMultipleOf(int factor, String name);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isLessThan(int maximumExclusive);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isLessThan(int maximumExclusive, String name);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isLessThanOrEqualTo(int maximumInclusive);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isLessThanOrEqualTo(int maximumInclusive, String name);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isGreaterThanOrEqualTo(int minimumInclusive);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isGreaterThanOrEqualTo(int minimumInclusive, String name);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isGreaterThan(int minimumExclusive);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isGreaterThan(int minimumExclusive, String name);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isBetween(int minimumInclusive, int maximumExclusive);
	 ...
	 */
	PrimitiveUnsignedIntegerValidator isBetween(int minimum, boolean minimumInclusive, int maximum,
