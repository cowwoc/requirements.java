	...
	implements PrimitiveShortValidator
{
	 ...
	 */
	public PrimitiveShortValidatorImpl(ApplicationScope scope, AbstractValidator<?> validator, String name,
		short value)
	{
	 ...
	 *                                  leading or trailing whitespace, or is empty.
	 */
	public PrimitiveShortValidatorImpl(ApplicationScope scope, Configuration configuration,
	 ...
	 *                                  leading or trailing whitespace, or is empty.
	 */
	private PrimitiveShortValidatorImpl(ApplicationScope scope, Configuration configuration,
