 ...
 */
public interface PrimitiveShortArrayValidator extends
	Validator<PrimitiveShortArrayValidator>,
	ObjectPart<PrimitiveShortArrayValidator, short[]>,
	ArrayPart<PrimitiveShortArrayValidator, Short, short[]>
{
	/**
	 ...
	 */
	PrimitiveShortArrayValidator contains(short expected);
	 ...
	 */
	PrimitiveShortArrayValidator contains(short expected, String name);
	 ...
	 */
	PrimitiveShortArrayValidator doesNotContain(short unwanted);
	 ...
	 */
	PrimitiveShortArrayValidator doesNotContain(short unwanted, String name);
	 ...
	 */
	ObjectArrayValidator<Short, Short[]> asBoxed();
}