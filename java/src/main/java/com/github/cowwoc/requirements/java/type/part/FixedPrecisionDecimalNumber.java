 ...
 */
public interface FixedPrecisionDecimalNumber<S>
{
	/**
	 ...
	 * @return this
	 * @throws NullPointerException     if the value is null
	 * @throws IllegalArgumentException if value is not a number or is an infinite number
	 * @see #isNumber()
	 ...
	 * @return this
	 * @throws NullPointerException     if the value is null
	 * @throws IllegalArgumentException if value is not a number or is a finite number
	 * @see #isNumber()
	 * @see Double#isInfinite()
	 */
	S isInfinite();
