...
public interface PrimitiveFloatArrayValidator extends
	Validator<PrimitiveFloatArrayValidator>,
	ObjectPart<PrimitiveFloatArrayValidator, float[]>,
	ArrayPart<PrimitiveFloatArrayValidator, Float, float[]>
{
	/**
	 ...
	 */
	ObjectArrayValidator<Float, Float[]> asBoxed();
}