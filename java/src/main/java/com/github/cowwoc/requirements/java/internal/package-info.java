 ...
 * <li>{@link com.github.cowwoc.requirements.java.GlobalRequirements GlobalConfiguration} is a
 * mechanism for exposing a selective subset of
 * {@link com.github.cowwoc.requirements.java.internal.scope.JvmScope JvmScope} to users.</li>
 * </ul>
 * <h2>JNI Strategy</h2>
 * <ul>
