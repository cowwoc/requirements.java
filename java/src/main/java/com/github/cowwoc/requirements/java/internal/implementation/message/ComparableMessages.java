...
public final class ComparableMessages
{
		...
		String nameOfValue, Object value, String operation, String nameOfOther, Object other)
	{
		...
		if (nameOfOther != null)
			messageBuilder.withContext(other, nameOfOther);
		if (value != null)
			messageBuilder.withContext(value, nameOfValue);
		...
		String nameOfValue, Integer value, String operation, String nameOfOther, int other, Pluralizer pluralizer)
	{
		...
		if (nameOfOther != null)
			builder.withContext(other, nameOfOther);
		if (value != null)
			builder.withContext(value, nameOfValue);
		return builder;
	}
