...
public interface PrimitiveByteValidator extends
	Validator<PrimitiveByteValidator>,
	NegativeNumber<PrimitiveByteValidator>,
	UnsignedNumber<PrimitiveByteValidator>
{
	/**
	 ...
	 */
	PrimitiveByteValidator isBetween(byte minimum, boolean minimumInclusive, byte maximum,
