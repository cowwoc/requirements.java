...
/**
 * Validates the state of a {@code Double} value.
 * <p>
...
public interface DoubleValidator extends
	...
	ObjectPart<DoubleValidator, Double>,
	NegativeNumber<DoubleValidator>,
	UnsignedNumber<DoubleValidator>,
	FixedPrecisionDecimalNumber<DoubleValidator>,
	DecimalNumber<DoubleValidator>
{
	/**
