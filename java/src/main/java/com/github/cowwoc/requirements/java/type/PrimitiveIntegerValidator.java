...
/**
 * Validates the state of an {@code int} value.
 * <p>
...
public interface PrimitiveIntegerValidator extends
	Validator<PrimitiveIntegerValidator>,
	NegativeNumber<PrimitiveIntegerValidator>,
	UnsignedNumber<PrimitiveIntegerValidator>
{
	/**
	 ...
	 */
	PrimitiveIntegerValidator isEqualTo(int expected);
	 ...
	 * @see ConfigurationUpdater#equalityMethod() The method used to compare objects
	 */
	PrimitiveIntegerValidator isEqualTo(int expected, String name);
	 ...
	 */
	PrimitiveIntegerValidator isNotEqualTo(int unwanted);
	 ...
	 */
	PrimitiveIntegerValidator isNotEqualTo(int unwanted, String name);
	 ...
	 */
	PrimitiveIntegerValidator isMultipleOf(int factor);
	 ...
	 */
	PrimitiveIntegerValidator isMultipleOf(int factor, String name);
	 ...
	 */
	PrimitiveIntegerValidator isNotMultipleOf(int factor);
	 ...
	 */
	PrimitiveIntegerValidator isNotMultipleOf(int factor, String name);
	 ...
	 */
	PrimitiveIntegerValidator isLessThan(int maximumExclusive);
	 ...
	 */
	PrimitiveIntegerValidator isLessThan(int maximumExclusive, String name);
	 ...
	 */
	PrimitiveIntegerValidator isLessThanOrEqualTo(int maximumInclusive);
	 ...
	 */
	PrimitiveIntegerValidator isLessThanOrEqualTo(int maximumInclusive, String name);
	 ...
	 */
	PrimitiveIntegerValidator isGreaterThanOrEqualTo(int minimumInclusive);
	 ...
	 */
	PrimitiveIntegerValidator isGreaterThanOrEqualTo(int minimumInclusive, String name);
	 ...
	 */
	PrimitiveIntegerValidator isGreaterThan(int minimumExclusive);
	 ...
	 */
	PrimitiveIntegerValidator isGreaterThan(int minimumExclusive, String name);
	 ...
	 */
	PrimitiveIntegerValidator isBetween(int minimumInclusive, int maximumExclusive);
